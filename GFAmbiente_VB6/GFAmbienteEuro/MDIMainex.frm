...
Begin VB.MDIForm MDIMain 
   BackColor       =   &H8000000C&
   Caption         =   "Bollettazione - Tassa Rifiuti "
   ClientHeight    =   7650
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   11505
...
Private Sub Pic_Paint()
    ...
    rotate pic, App.CompanyName & " " & App.LegalCopyright & " ver. " & App.Major & "." & App.Minor & "." & App.Revision, 23
    DoEvents
End Sub
