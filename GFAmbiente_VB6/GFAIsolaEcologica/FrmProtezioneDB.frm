...
Private Sub cmdEncrypt_Click()
    ...
    txtText.Tag = txtText
    txtText.Tag = getTextDecrypt(txtText.Tag)
...
Private Sub Form_Load()
    ...
    txtPassword.Text = getTextDecrypt("gfambiente")
    i = 0
    Do
        ...
        If returnString <> "" Then
            ...
            password = getTextDecrypt(returnString)
...
Private Sub mnuImpostaPassword_Click()
    ...
    On Error GoTo mnuImpostaPassword_ClickERR
    Dim i As Integer
    
    
    For i = 1 To DevEnvMDB.Connections.Count
        If DevEnvMDB.Connections(i).state = adStateOpen Then
    ...
    If gDBC.Errors.Count > 0 Then
        gDBC.Errors.Clear
        On Error GoTo mnuImpostaPassword_ClickERR
        gDBC.Execute "ALTER Database Password " & lvw.SelectedItem.ListSubItems(1) & " null"
    End If
    ...
    cmdSave_Click
    Exit Sub
mnuImpostaPassword_ClickERR:
    MsgBox "mnuImpostaPasswordClick:" & Err.Description, vbCritical + vbOK, App.Title
